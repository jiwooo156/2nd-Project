        ...
        <div class="main_4_box">
          ...
          <div class="main_box_right">
            <div class="main_4_menu">
              ...
              <router-link to="/board?flg=1">정보<br>게시판<font-awesome-icon :icon="['fas', 'file-pen']" /></router-link>
              <router-link to="/qna?flg=2">질문<br>게시판<font-awesome-icon :icon="['fas', 'leaf']" /></router-link>
