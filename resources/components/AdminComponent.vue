<template>
			...
			<div>
				...
				<div class="admin_content pointer">
					...
					v-for="data in data" :key="data"
						@click="dataget(data.id)"
					>
						<div>유저id : {{ data.u_id }}</div>
	...
	>
		<div class="admin_modal">
			<div 
				v-if="Object.keys(this.modalData).length > 0"
			>
				...
				<div class="admin_modal_btn_box">
					<div class="admin_modal_btn pointer">답변</div>
					<div class="admin_modal_btn pointer"
						@click="this.modalflg=false"
					>취소</div>
				</div>
			</div>
			<div 
